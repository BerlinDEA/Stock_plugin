...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a id="test" class="navbar-brand" href="#">Artikel Export</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li{if {controllerAction} === 'index'} class="active"{/if}><a href="{url controller="Artikel_Export" action="index" __csrf_token=$csrfToken}">Artikel Export</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>
